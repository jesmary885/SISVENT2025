        ...
        <div class="card">
            <div class="p-6">
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                        ...
                        <div>
                            ...
                            <select id="tipo_documento" wire:model.defer="tipo_documento" class="w-full bg-gray-50 border border-gray-300 text-gray-700 py-2 px-3 pr-8 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200">
                ...
                <div class="mb-8">
                    ...
                    <div class="flex flex-col md:flex-row items-start md:items-center gap-6">
                        ...
                        <div class="w-full md:w-2/3">
                            ...
                            <input type="file" id="logo" wire:model.defer="logo" name="logo" class="block w-full  text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-medium file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100 transition duration-200" accept="image/*">
                ...
                <div class="flex justify-end mt-6">
                    <button wire:click="update()" type="submit" class="bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-6 rounded-lg flex items-center transition duration-200 transform hover:-translate-y-0.5 shadow-md hover:shadow-lg">
